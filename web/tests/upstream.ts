...
export function fixture() {
  const values = {
    ...
    // A balance sheet that adds up: 90 + 210 current and non-current assets,
    // funded by 45 + 55 of liabilities and 200 of equity.
    annualCashAndCashEquivalents: 40e6,
    annualAccountsReceivable: 30e6,
    annualInventory: 20e6,
    annualCurrentAssets: 90e6,
    annualTotalNonCurrentAssets: 210e6,
    annualTotalAssets: 300e6,
    annualAccountsPayable: 25e6,
    annualCurrentDebt: 15e6,
    annualCurrentLiabilities: 45e6,
    annualLongTermDebt: 40e6,
    annualTotalNonCurrentLiabilitiesNetMinorityInterest: 55e6,
    annualTotalLiabilitiesNetMinorityInterest: 100e6,
    annualRetainedEarnings: 120e6,
    annualStockholdersEquity: 200e6,
